...
export const products: ProductItem[] = [
    ...
    variants: [
      {
        ...
        descriptionZh: '带 POLICE 标识的黑色软质背心款式，适合执法、安防和机构采购场景展示。',
        image: '/images/products/vest/防弹背心3正.jpg',
        gallery: ['/images/products/vest/防弹背心3正.jpg', '/images/products/vest/防弹背心3反.jpg'],
        tags: ['警用款', '软质背心', '黑色外观'],
      },
      {
        id: 'police-tactical-vest',
        nameZh: '警用战术防弹衣',
        nameFr: 'Gilet tactique police',
        descriptionZh: '黑色警用战术背心结构，带附件区和模块化外观，适合执法装备配置展示。',
        image: '/images/products/vest/警用防弹衣1正.jpg',
        gallery: [
      ...
      },
      {
        id: 'concealable-vest',
        nameZh: '隐蔽式防弹背心',
        nameFr: 'Gilet discret souple',
        descriptionZh: '外观更简洁的软质防护背心，可用于内穿、低调防护或基础款式资料展示。',
      ...
      {
        id: 'tactical-plate-carrier',
        nameZh: '战术板载背心',
        nameFr: 'Gilet modulaire',
        descriptionZh: '沙色、黑色及迷彩战术板载背心款式，可用于插板搭配和装备系统配套展示。',
  ...
  },
  {
    ...
    variants: [
      ...
      {
        id: 'white-helmet-shell',
        nameZh: '白色头盔壳体',
        nameFr: 'Coque de casque blanche',
        descriptionZh: '白色头盔壳体素材，适合材料结构、基础壳体或定制颜色方案展示。',
        image: '/images/products/helmet/白头盔正.jpg',
        gallery: ['/images/products/helmet/白头盔正.jpg', '/images/products/helmet/白头盔侧.jpg'],
        tags: ['白色壳体', '材料展示', '定制颜色'],
      },
    ],
    tags: ['头部防护', '轻量化', '专业装备'],
